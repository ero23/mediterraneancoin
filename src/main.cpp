...
uint256 hashGenesisBlock("0x9c34cebf033b69a6ac680e8fc3febb0b96a54d3323cd0ca2548bbd91fadd5d3d");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nNonce   = 58519604;

        if (fTestNet)
        {
            block.nTime    = 1380408162;
            block.nNonce   = 385873214;
        }
